package com.esprit.infrastructure.adapter.output.customizedexception;

import com.esprit.domain.exception.ProductNotFound;
import com.esprit.infrastructure.adapter.output.customizedexception.data.response.ExceptionResponse;
